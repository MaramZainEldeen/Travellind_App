...
// الستايل تبع البوكس الذي تحت العنوان(الانشطة )
  ...
  Widget build(BuildContext context) {
    ...
    // (id)للبحث عن بيانات الرحلة التي ستعرض تفاصيلها من خلال ال
    ...
    return Scaffold(
              ...
              ListView.builder(
                ...
                itemBuilder: (ctx, index) => Column(
                  children: [
                    ...
                    //لعمل خط فاصل بين العناصر المتواجدة تحت العنوان
                    Divider(),
                  ],
                ),
              ),
      ...
      // زر اضافة للصفحة المفضلة عند الضغط عبيه
      /* floatingActionButton: FloatingActionButton(
